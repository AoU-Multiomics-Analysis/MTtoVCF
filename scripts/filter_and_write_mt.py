...
if __name__ == "__main__":
    ...
    parser.add_argument("--SparkLocalThreads", type=_spark_local_threads, default='*', help="Spark local worker threads, or '*' for all visible CPUs.")
    parser.add_argument("--SparkDriverMemory", default='64g', help="Spark driver memory, for example 64g or 400g.")
    parser.add_argument("--SparkParallelism", type=_positive_int, default=100, help="Spark default parallelism.")
