...
For larger runs, a starting profile might be `TaskCpu = 128`, `TaskMemory = "512G"`, `TaskDisk = "local-disk 2000 SSD"`, `SparkDriverMemory = "400g"`, `SparkParallelism = 512`, and `SparkShufflePartitions = 512`.
